...
Credits:Label("ShownApe#1000 - Scripting")
Credits:Label("outlaw#3610 - Scripting help")
Credits:Label("This script uses Turtle UI Lib")
Credits:Label("Join the server for updates")
Credits:Button("Copy discord invite", function()
	if setclipboard then
		setclipboard("https://discord.gg/XR6kEcDhtU")
	end
end)
